...
extern bool hyundai_canfd_high_torque;
bool hyundai_canfd_high_torque = false;
...
void hyundai_common_init(uint16_t param) {
  ...
  const uint16_t HYUNDAI_PARAM_CANFD_HIGH_TORQUE = 2048;
  ...
  hyundai_canfd_high_torque = GET_FLAG(param, HYUNDAI_PARAM_CANFD_HIGH_TORQUE);
