...
static bool hyundai_canfd_tx_hook(const CANPacket_t *msg) {
  const TorqueSteeringLimits HYUNDAI_CANFD_STEERING_LIMITS = {
    .max_torque = hyundai_canfd_high_torque ? 409 : 270,
    .max_rt_delta = hyundai_canfd_high_torque ? 375 : 112,
    .max_rate_up = hyundai_canfd_high_torque ? 10 : 2,
    .max_rate_down = hyundai_canfd_high_torque ? 10 : 3,
